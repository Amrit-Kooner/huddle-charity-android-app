...
public class CreateNewsFragment extends Fragment {
     ...
     * @return A new instance of fragment NewsCreateFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsImage = view.findViewById(R.id.mainImage);
        ...
        confirm_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference newsRef = FirebaseDatabase.getInstance().getReference("news").push();
                newsID = newsRef.getKey();
                writeNewNews(editTextTitle.getText().toString(), editTextBio.getText().toString(), editTextDescription.getText().toString(), editTextLink.getText().toString(),"");

                DatabaseReference news = FirebaseDatabase.getInstance().getReference().child("news").child(newsID);

                news.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            NewsClass news = snapshot.getValue(NewsClass.class);
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        picasso.load(imageUri).into(newsImage);
                    }
                }
            });
    ...
    private void uploadToFirebase(Uri uri){
        ...
        DatabaseReference newsRef = FirebaseDatabase.getInstance().getReference().child("news").child(newsID).child("image");
    ...
    public void writeNewNews(String title, String bio, String description, String link, String image) {
        DatabaseReference newsRef = FirebaseDatabase.getInstance().getReference("news").push();
        newsID = newsRef.getKey();


        NewsClass newNews = new NewsClass(title, bio, description, link, image);
        newsRef.setValue(newNews);
        uploadToFirebase(imageUri);
        Toast.makeText(getActivity(), "New News Created!", Toast.LENGTH_SHORT).show();
    }
